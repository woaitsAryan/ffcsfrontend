    ...
    <div className={`${styles.container} ${fadeOut ? styles['fade-out'] : ''}`}>
      <div>
        ...
        <h2 className={styles.header}>
          Hey,
          <img src="Waving Hand.png" className={styles['waving-emoji']} alt="Waving Hand" />
        </h2>
        ...
        <div className={styles['btn-container']}>
          <button className={val==='login'?styles['btn-login']:styles['invis']} onClick={handleLogin_}>
            Go to Login
          </button>
          <button className={val==='register'?styles['btn-signUp']:styles['invis']} onClick={handleRegister_}>
            Go to Register
          </button>
        </div>
      </div>
